...
function exp_Roads_3rule0_eval_expression(context) {
    // RoadType_E = 'internal'
...
function exp_Roads_3rule1_eval_expression(context) {
    // RoadType_E = 'Local'
...
function exp_Roads_3rule2_eval_expression(context) {
    // RoadType_E = 'Main'
...
function exp_Roads_3rule3_eval_expression(context) {
    // RoadType_E = 'Regional'
...
function exp_Roads_3rule4_eval_expression(context) {
...
function exp_Roads_3rule5_eval_expression(context) {
...
function exp_Roads_3rule6_eval_expression(context) {
    // RoadType_E = 'Unused'
